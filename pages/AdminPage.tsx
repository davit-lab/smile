...
const AdminPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'about' | 'team' | 'pricing' | 'blog' | 'leads' | 'footer' | 'photos'>('blog');
    ...
    <div className="min-h-screen bg-[#f8fafc] flex">
      <div className="w-80 bg-[#0c0c0c] flex flex-col fixed h-full z-[100] shadow-2xl">
        ...
        <nav className="flex-1 p-6 space-y-1 overflow-y-auto hide-scrollbar">
          {['about', 'team', 'pricing', 'blog', 'leads', 'footer', 'photos'].map(id => (
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          {activeTab === 'photos' && (
            <div className="space-y-12">
              ...
              <div className="space-y-6">
                <h3 className="text-xl font-black uppercase tracking-tight text-gray-400 ml-2">Page Banners</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <InputPair label="About Hero" path="media.about_hero" isImage={true} />
