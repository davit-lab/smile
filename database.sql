...
-- Please create a public bucket named 'media' in the Supabase Storage dashboard.
-- Set the following bucket policies:
-- 1. "Public Access" - Allow SELECT for all users (public)
-- 2. "Public Upload" - Allow INSERT for all users (or authenticated if you prefer)
-- 3. "Public Update/Delete" - Allow UPDATE/DELETE for all users (or authenticated)
